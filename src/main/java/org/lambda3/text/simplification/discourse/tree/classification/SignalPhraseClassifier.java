...
//            new Mapping(Relation.BACKGROUND, "previously"),
    ...
    public static Optional<Relation> classifyCustom(List<Mapping> mappings, List<Word> signalPhraseWords) {
        return classify(mappings, signalPhraseWords);
    }

    public static Optional<Relation> classifyGeneral(List<Word> signalPhraseWords) {
